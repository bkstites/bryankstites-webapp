#!/usr/bin/env python3
"""
Narrative Model Testing Framework
================================

This script provides comprehensive testing of the EMS AI Triage System's
narrative analysis capabilities, including accuracy metrics, qualitative
assessment, and detailed performance analysis.
"""
...
class NarrativeModelTester:
    """Comprehensive testing framework for the narrative analysis model"""
        ...
        try:
            ...
            response = requests.post(
                ...
                json={
                    ...
                    "patient_id": f"test_{test_case.id}"
                },
                timeout=10
            )
            ...
            # Extract results
            actual_protocols = [p["protocol_name"] for p in data.get("protocol_matches", [])]
            actual_urgency = data.get("urgency_level", "Unknown")
            actual_keywords = [k["keyword"] for k in data.get("keywords", [])]
    ...
    def run_comprehensive_test(self) -> Dict[str, Any]:
        ...
        print("🚑 Starting Comprehensive Narrative Model Testing...")
        print("=" * 60)
...
def main():
    ...
    print("🚑 EMS AI Triage System - Narrative Model Testing")
    print("=" * 60)
    
    # Initialize tester
    tester = NarrativeModelTester()
    ...
    filename = f"narrative_model_test_results_{timestamp}.json"
